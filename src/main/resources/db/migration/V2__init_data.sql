...
INSERT INTO offer (title, description, user_creator_id, occupation_id, price)
VALUES ('Установка плит', '5 плит, высота 4 м', 1, 6, 2200.54),
       ('Предложение_2', 'Описание_2', 2, 3, 11),
       ('Предложение_3', 'Описание_3', 2, 5, 22),
       ('Предложение_4', 'Описание_4', 1, 4, 33),
       ('Установка плит', '5 плит, высота 4 м', 1, 6, 44),
       ('Предложение_5', 'Описание_5', 1, 1, 55);
